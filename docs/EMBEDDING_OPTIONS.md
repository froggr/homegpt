# Embedding Model Options for HomeGPT

This document compares embedding model formats and providers for semantic search in HomeGPT.
...
embedding_cache_dir = "~/.cache/homegpt/models"
```
...
[memory]
embedding_provider = "gguf"
embedding_model = "~/.cache/homegpt/models/embeddinggemma-300M-Q8_0.gguf"
```
